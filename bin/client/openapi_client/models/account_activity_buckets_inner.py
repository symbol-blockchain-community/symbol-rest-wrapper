...
class AccountActivityBucketsInner(BaseModel):
    """
    AccountActivityBucketsInner
    """ # noqa: E501
    start_height: StrictStr = Field(alias="startHeight")
    total_fees_paid: StrictStr = Field(alias="totalFeesPaid")
    beneficiary_count: Union[StrictFloat, StrictInt] = Field(alias="beneficiaryCount")
    raw_score: StrictStr = Field(alias="rawScore")
