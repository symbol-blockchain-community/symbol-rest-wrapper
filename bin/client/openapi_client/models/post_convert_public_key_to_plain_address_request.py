...
class PostConvertPublicKeyToPlainAddressRequest(BaseModel):
    """
    PostConvertPublicKeyToPlainAddressRequest
    """ # noqa: E501
    var_from: PublicKey = Field(alias="from")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "from": PublicKey.from_dict(obj.get("from")) if obj.get("from") is not None else None
        })
        return _obj
