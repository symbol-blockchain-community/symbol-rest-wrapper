...
class UnresolvedAddress(BaseModel):
    """
    UnresolvedAddress
    """ # noqa: E501
    unresolved_address: StrictStr = Field(alias="unresolvedAddress")
    __properties: ClassVar[List[str]] = ["unresolvedAddress"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "unresolvedAddress": obj.get("unresolvedAddress")
        })
        return _obj
