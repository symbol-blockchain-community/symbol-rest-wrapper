...
class AccountSupplementalPublicKeysVotingPublicKeysInner(BaseModel):
    """
    AccountSupplementalPublicKeysVotingPublicKeysInner
    """ # noqa: E501
    public_key: StrictStr = Field(alias="publicKey")
    start_epoch: Union[StrictFloat, StrictInt] = Field(alias="startEpoch")
    end_epoc: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="endEpoc")
    __properties: ClassVar[List[str]] = ["publicKey", "startEpoch", "endEpoc"]
