...
class AccountSupplementalPublicKeysVoting(BaseModel):
    """
    AccountSupplementalPublicKeysVoting
    """ # noqa: E501
    public_keys: List[AccountSupplementalPublicKeysVotingPublicKeysInner] = Field(alias="publicKeys")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "publicKeys": [AccountSupplementalPublicKeysVotingPublicKeysInner.from_dict(_item) for _item in obj.get("publicKeys")] if obj.get("publicKeys") is not None else None
        })
        return _obj
