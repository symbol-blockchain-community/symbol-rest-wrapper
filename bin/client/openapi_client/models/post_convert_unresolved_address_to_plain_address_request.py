...
class PostConvertUnresolvedAddressToPlainAddressRequest(BaseModel):
    """
    PostConvertUnresolvedAddressToPlainAddressRequest
    """ # noqa: E501
    var_from: UnresolvedAddress = Field(alias="from")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "from": UnresolvedAddress.from_dict(obj.get("from")) if obj.get("from") is not None else None
        })
        return _obj
