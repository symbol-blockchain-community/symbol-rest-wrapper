...
class NodeApi:
    ...
    def get_nodes(
        self,
        network_type: Annotated[Optional[NetworkType], Field(description="default value is mainnet")] = None,
        ...
        :param network_type: default value is mainnet
    ...
    def get_nodes_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetNodes200Response]:
        """get living node
    ...
    def _get_nodes_serialize(
        ...
        if network_type is not None:
            ...
            _query_params.append(('networkType', network_type.value))
